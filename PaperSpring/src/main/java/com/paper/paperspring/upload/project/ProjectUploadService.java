...
public class ProjectUploadService extends Upload {
    ...
    public ProjectDto uploadProject(String title, String content, List<MultipartFile> images) {
    ...
    private ProjectDto convertProjectDto(ProjectEntity projectEntity) {
        ...
        return new ProjectDto(projectEntity.getId(), projectEntity.getTitle(), projectEntity.getContent(), imageDtos);
    }
